...
export const DC_ZONE_MAP: Record<string, string> = {
  ...
  // ── Oracle ────────────────────────────────────────────────────────────────
  'oc-us-ashburn-1':   'US-MIDA-PJM',
  'oc-us-phoenix-1':   'US-SW-AZPS',
  'oc-us-chicago-1':   'US-MIDW-MISO',
  'oc-us-sanjose-1':   'US-CAL-CISO',
  'oc-ca-toronto-1':   'CA-ON',
  'oc-ca-montreal-1':  'CA-QC',
  'oc-eu-frankfurt-1': 'DE',
  'oc-eu-amsterdam-1': 'NL',
  'oc-eu-london-1':    'GB',
  'oc-eu-paris-1':     'FR',
  'oc-eu-milan-1':     'IT-NO',
  'oc-eu-stockholm-1': 'SE',
  'oc-eu-madrid-1':    'ES',
  'oc-eu-zurich-1':    'CH',
  'oc-me-dubai-1':     'AE',
  'oc-me-abudhabi-1':  'AE',
  'oc-me-jeddah-1':    'SA',
  'oc-af-johannesburg-1': 'ZA',
  'oc-ap-mumbai-1':    'IN-WE',
  'oc-ap-hyderabad-1': 'IN-SO',
  'oc-ap-singapore-1': 'SG',
  'oc-ap-sydney-1':    'AU-NSW',
  'oc-ap-melbourne-1': 'AU-VIC',
  'oc-ap-osaka-1':     'JP-KY',
  'oc-ap-tokyo-1':     'JP-TK',
  'oc-ap-seoul-1':     'KR',
  'oc-ap-chuncheon-1': 'KR',
